...
class NotificationPlugin {
  ...
  Future<void> showDailyAtTime(time) async {
    var androidChannelSpecifics = AndroidNotificationDetails(
      'CHANNEL_ID 4',
      'CHANNEL_NAME 4',
    ...
    await flutterLocalNotificationsPlugin.showDailyAtTime(
      0,
      'Alert!',
      "Don't Forget to Backup your Memories",
      time,
      platformChannelSpecifics,
  ...
  Future<void> showDailyAtTimeNoti(time,tit) async {
    var androidChannelSpecifics = AndroidNotificationDetails(
      'CHANNEL_ID 4',
      'CHANNEL_NAME 4',
      "CHANNEL_DESCRIPTION 4",
  ...
  Future<void> scheduleNotification(dur,col) async {
    var scheduleNotificationDateTime = DateTime.now().add(dur);
    var androidChannelSpecifics = AndroidNotificationDetails(
      'CHANNEL_ID 1',
      'CHANNEL_NAME 1',
