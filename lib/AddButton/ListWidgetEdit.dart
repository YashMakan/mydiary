...
class FirstEditPage extends StatefulWidget {
  ...
  const FirstEditPage({Key key, this.emojiMood, this.date, this.title, this.body, this.elemPos, this.files, this.selected, this.values, this.bodyColor, this.bold, this.bodyFont, this.bodyFontSize, this.bodyAlign, this.selectedHeading, this.allindex, this.tapindex, }) : super(key: key);
  @override
  _FirstEditPageState createState() => _FirstEditPageState();
}

class _FirstEditPageState extends State<FirstEditPage> {
  List elements = [
        ...
        title: Row(children: <Widget>[
          ...
          GestureDetector(onTap: ()async{
            var val = await Navigator.push(context, new MaterialPageRoute(
              builder: (BuildContext context) => new MoodStyle(hoosen:choosen),
          ...
          },child: Text("MORE",style: TextStyle(color: Colors.blue,fontSize: MediaQuery.of(context).size.width*0.025),)),
        ],),
  ...
  changes(){
    files=List<String>.from(widget.files);
    allindex=widget.allindex;
    position=widget.elemPos!=null?Offset(widget.elemPos[1],widget.elemPos[2]):null;
    int year=int.parse(widget.date[2].toString().replaceAll(' ', '').trim().replaceAll('\n', ''));
    int month=months.indexOf(widget.date[1].toString().replaceAll(' ', '').trim().replaceAll('\n', ''))+1;
    int date1=int.parse(widget.date[0].toString().replaceAll(' ', '').trim().replaceAll('\n', ''));
    date=DateTime(year,month,date1);

    emojiMood=widget.emojiMood.trim().replaceAll('\n','');
        ...
        actions: <Widget>[
          ...
          Padding(
            ...
            child: Center(child: GestureDetector(onTap:()async{
              ...
              int ind=widget.tapindex;
              temp.removeAt(ind);
              temp.insert(ind, allText);
              //developer.log(allText);
              await setList(temp);
              Navigator.push(context, new MaterialPageRoute(
                builder: (BuildContext context) => new MyHomePage(),)
              );
            }, child: Text('SAVE',style: TextStyle(color: Colors.blue,fontWeight: FontWeight.w600),))),
          ),
        ],
      ),
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: GridView.count(
                      ...
                      children: <Widget>[
                        GestureDetector(onTap:(){borderToList=0;mainFunction2();},child: Container(decoration: BoxDecoration(border: Border.all(color: borderToList==0?Colors.black:Colors.transparent)),child: Image.asset('assets/background/list1.png',fit: BoxFit.fill,))),
                        GestureDetector(onTap:(){borderToList=1;mainFunction2();},child: Container(decoration: BoxDecoration(border: Border.all(color: borderToList==1?Colors.black:Colors.transparent)),child: Image.asset('assets/background/list2.png',fit: BoxFit.fill))),
                        GestureDetector(onTap:(){borderToList=2;mainFunction2();},child: Container(decoration: BoxDecoration(border: Border.all(color: borderToList==2?Colors.black:Colors.transparent)),child: Image.asset('assets/background/list3.png',fit: BoxFit.fill))),
                        GestureDetector(onTap:(){borderToList=3;mainFunction2();},child: Container(decoration: BoxDecoration(border: Border.all(color: borderToList==3?Colors.black:Colors.transparent)),child: Image.asset('assets/background/list4.png',fit: BoxFit.fill))),
                        GestureDetector(onTap:(){borderToList=4;mainFunction2();},child: Container(decoration: BoxDecoration(border: Border.all(color: borderToList==4?Colors.black:Colors.transparent)),child: Image.asset('assets/background/list5.png',fit: BoxFit.fill))),
                        GestureDetector(onTap:(){borderToList=5;mainFunction2();},child: Container(decoration: BoxDecoration(border: Border.all(color: borderToList==5?Colors.black:Colors.transparent)),child: Image.asset('assets/background/list6.png',fit: BoxFit.fill))),
                      ],
                    ),
                  )
                ],),
                      ...
                      Padding(
                        ...
                        child: Row(children: <Widget>[
                          GestureDetector(onTap: (){
                            ...
                            fontSizeCheck();
                            mainFunction2();
                          },child: Text('H1',style: TextStyle(color: selectedHeading=='H1'?Colors.blue:Colors.black38, fontSize: app.size.width*0.053),textAlign: TextAlign.end,)),
                          Padding(
                            ...
                            child: GestureDetector(onTap:(){
                              ...
                              fontSizeCheck();
                              mainFunction2();
                            },child: Text('H2',style: TextStyle(color: selectedHeading=='H2'?Colors.blue:Colors.black38, fontSize: app.size.width*0.043),textAlign: TextAlign.end)),
                          ),
                          GestureDetector(onTap: (){
                            selectedHeading=='H3'?selectedHeading='':selectedHeading='H3';
                            fontSizeCheck();
                            mainFunction2();
                          }, child: Text('H3',style: TextStyle(color: selectedHeading=='H3'?Colors.blue:Colors.black38, fontSize: app.size.width*0.037),textAlign: TextAlign.end)),
                        ],),
                      )
                    ],),
                  SizedBox(height: 1,),
                    ...
                    child: GridView.count(
                        ...
                        children: List.generate(19, (index) {
                          return GestureDetector(onTap: (){
                            ...
                            mainFunction2();
                          },child: Container(decoration: BoxDecoration(color: Color(0xffdce8f4),border: Border.all(color:fontButtonIndex==index?Colors.blue:Colors.transparent)),child: Center(child: Text(fontsNames[index],style: TextStyle(fontFamily: fontsNames[index]),))));
                        })
                    ),
                  )
                ],),
